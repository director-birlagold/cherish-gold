...
if($_SERVER['HTTP_HOST']=='localhost' || $_SERVER['HTTP_HOST']=='192.168.1.20'){
	$baseUrl = '/shagunn/app/webroot/img/';
}elseif($_SERVER['HTTP_HOST']=='cherrybells.in' || $_SERVER['HTTP_HOST']=='www.cherrybells.in'){
	$baseUrl = '/shagunn/app/webroot/img/';
}elseif($_SERVER['HTTP_HOST']=='shagunn.in' || $_SERVER['HTTP_HOST']=='www.shagunn.in'){
	$baseUrl = '/app/webroot/img/';
}
/*
