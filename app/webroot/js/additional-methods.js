...
jQuery.validator.addMethod("divisible100", function(value, element, params) { 
    return this.optional(element) || /00$/.test(value);
}, $.format("Please enter amount greater then 1000 and divisible by 100.")); 
...
jQuery.validator.addMethod("IFSC", function(value, element) {
	return this.optional(element) || /([0-9].*[a-z])|([a-z].*[0-9])|([0-9].*[A-Z])|([A-Z].*[0-9])/.test(value);
}, "IFSC must contain atleast one digit and one letter.");