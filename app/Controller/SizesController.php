...
class SizesController extends AppController {
    ...
    public function admin_index() {
		...
		if ($this->request->query('search') != '') {
            ...
            }						/* if (($this->request->query('cdate') != '') && ($this->request->query('edate'))) {				$conditions['created_date >='] = $this->request->query('cdate');				$conditions['created_date <='] = $this->request->query('edate');            } elseif ($this->request->query('edate') != '') {               $conditions['created_date >='] = $this->request->query('cdate');            } elseif ($this->request->query('cdate')) {               $conditions['created_date >='] = $this->request->query('cdate');            } */
        } else {
