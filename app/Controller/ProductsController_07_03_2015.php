 ...
 */
	...
	public $uses=array('Product','Vendorcontact','Vendor','Category','Subcategory','Productstone','Productimage','Size','Metalcolor','Metal','Diamond','Clarity','Color','Carat','Shape','Settingtype','Purity','Productmetal','Productgemstone','Productdiamond','Gemstone','Price');
	public $layout='admin';
	...
	public function admin_add(){	
		...
		}else{ $this->request->data['Product']['certificate_image']='';
		}
		...
		$color_id = $this->Color->find('first',array('conditions'=>array('color'=>$color_1), 'fields' => array('color_id')));	
		$clarity_id = $this->Clarity->find('first',array('conditions'=>array('clarity'=>$clarity_1), 'fields' => array('clarity_id')));	
		
		$this->request->data['Product']['product_id']=$product_id;			
		$this->request->data['Product']['stoneweight']=$value_1;
