...
class WebpagesController extends AppController {
    ...
    public function calculate_price() {
        ...
        if (!empty($gcolor)) {
            ...
            $gold_price = round(round($goldprice['Price']['price'] * ($material[0] / 24), 0, PHP_ROUND_HALF_DOWN) * $tot_weight, 0, PHP_ROUND_HALF_DOWN);
            $purity = $material[0];
		...
		/*echo "Gold :".$gold_price; echo "<br/>";
		echo "Diamond :".$stone_price; echo "<br/>";
		echo "Gemstone :".$gemprice; echo "<br/>";
		echo "MC :".$gold_price * ($making_charge / 100); echo "<br/>";
		echo "Vat :".($sub_total + $making) * ($product['Product']['vat_cst'] / 100); echo "<br/>";*/
