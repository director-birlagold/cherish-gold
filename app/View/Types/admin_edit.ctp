       ...
       <?php echo $this->Form->create('Type',array('id'=>'myForm','type' => 'file','inputDefaults' => array ('fieldset' => false, 'legend' => false))); ?>        	
            <fieldset>
				...
				<?php	
                     ...
                     echo $this->Form->input('vendor_type',array('div'=>false,'error'=>false,'label' => array('text'=>'Status'.'<span class="required">*</span>'), 'before' => '<dt>', 'after' => '</dd>', 'between' => '</dt><dd>', 'class'=>'validate[required]','size'=>'50'));
