		...
		<table cellpadding="0" cellspacing="0" border="0" width="45%" class="bdrdottTd" >	
        	...
        	<tr>
              ...
              <tr>
            	<td>Address</td>
            	<td>:</td>
            	<td  class="details"><?php if(!empty($user['User']['address'])){echo  nl2br($user['User']['address']);}else{echo '--';}?></td>
                
                <td class="detail" style="display:none;">
                
                  
                <input type="text" name="data[User][address]"  value="<?php echo $user['User']['address'];?>"/>
