...
<div id="content"  class="clearfix">			
    <div class="container">
       ...
       <?php echo $this->Form->create('Diamond',array('id'=>'myForm','type' => 'file','inputDefaults' => array ('fieldset' => false, 'legend' => false))); ?>        	
            <fieldset>
                <legend><?php echo __('Add Diamond');?></legend>
                 <dl class="inline">
				<?php	
				   			
                     echo $this->Form->input('name',array('div'=>false,'error'=>false,'label' => array('text'=>'Name'.'<span class="required">*</span>'), 'before' => '<dt>', 'after' => '</dd>', 'between' => '</dt><dd>', 'class'=>'validate[required,custom[onlyLetterSp]]','size'=>'50','maxlength'=>'50'));
