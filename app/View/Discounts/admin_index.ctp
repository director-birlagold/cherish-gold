<div id="content" class="clearfix"> 
    <div class="container">
        ...
        <div class="tablefooter clearfix">
            ...
            <td><input type="radio" <?php if(isset($_REQUEST['searchtype'])  && $_GET['searchtype']=="Vouchercode") { ?> checked="checked" <?php } ?>  id="checklist" class="radio metal" name="searchtype" value="Vouchercode" <?php if(isset($_REQUEST['searchtype'])){echo $_REQUEST['searchtype'];}?> />Voucher Code&nbsp;&nbsp;&nbsp;
           <input type="radio" <?php if(isset($_REQUEST['searchtype'])  && $_GET['searchtype']=="Product") { ?> checked="checked" <?php } ?>  id="checklist" class="radio metal" name="searchtype" value="Product" <?php if(isset($_REQUEST['searchtype'])){echo $_REQUEST['searchtype'];}?> />Product&nbsp;&nbsp;&nbsp;
            <input type="radio"  <?php if(isset($_REQUEST['searchtype'])  && $_GET['searchtype']=="User") { ?> checked="checked" <?php } ?>  id="checklist" class="radio metal" name="searchtype" value="User" <?php if(isset($_REQUEST['searchtype'])){echo $_REQUEST['searchtype'];}?> />User&nbsp;&nbsp;&nbsp;
            <input type="radio" <?php if(isset($_REQUEST['searchtype'])  && $_GET['searchtype']=="Category") { ?> checked="checked" <?php } ?> id="checklist" class="radio metal" name="searchtype" value="Category" <?php if(isset($_REQUEST['searchtype'])){echo $_REQUEST['searchtype'];}?> />Category&nbsp;&nbsp;&nbsp;
           </td> 
        ...
        <tr>
         ...
         <th align="left"><?php echo $this->Paginator->sort('voucher_code','Voucher code');?></th> 
          <th align="left"><?php echo $this->Paginator->sort('percentage','Percentage / Amount');?></th> 
        ...
        <td align="left"><?php  echo $discounts['Discount']['type'];?></td>
         <td align="left"><?php  echo $discounts['Discount']['voucher_code'];?></td>
        <td align="left"><?php  echo $discounts['Discount']['percentage']; if($discounts['Discount']['per_amou']==1) { echo " % ";} else { echo " RS " ; }?></td>
