                ...
                <legend><?php echo __('Edit Discount');?></legend>
                 <dl class="inline">
						 <dt><label for="name">Type </label></dt>
                            <dd><strong><?php echo $discount['Discount']['type'];?></strong></dd>
                           ...
                           size="50"  value="<?php echo $discount['Discount']['percentage']?>" / ></dd>
                              <dt><label for="name">Start Date<span class="required">*</span></label></dt>     
                           <dd><input type="text" name="data[Discount][start_date]" id="startdate"   class="validate[required]" size="50" value="<?php echo $discount['Discount']['start_date']?>"  /></dd>
                             <dt><label for="name">End Date<span class="required">*</span></label></dt>     
                           <dd><input type="text" name="data[Discount][expired_date]" id="expireddate"   class="validate[required]" size="50"  value="<?php echo $discount['Discount']['expired_date']?>"  /></dd>
