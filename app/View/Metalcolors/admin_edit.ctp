...
<div id="content"  class="clearfix">			
    <div class="container">
       ...
       <?php echo $this->Form->create('Metalcolor',array('id'=>'myForm','type' => 'file','inputDefaults' => array ('fieldset' => false, 'legend' => false))); ?>        	
            <fieldset>
                <legend><?php echo __('Edit Metal Color');?></legend>
                 <dl class="inline">
                   <dt><label for="name">Metal<span class="required">*</span></label></dt>
                       <dd>
						...
						echo '<option value="'.$metals['Metal']['metal_id'].'" '.($this->request->data['Metalcolor']['metal_id']==$metals['Metal']['metal_id']?'selected="selected"':'').'>'.$metals['Metal']['metal_name'].'</option>';
