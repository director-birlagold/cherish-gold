            ...
            <fieldset>
                <legend><?php echo __('Add Color');?></legend>
				 ...
				 foreach($clarity as $clarities) {
					  if (isset($this->request->data['Color']['clarity']) && $this->request->data['Color']['clarity'] == $clarities['Clarity']['clarity']) {
                                            echo '<option value="' . $clarities['Clarity']['clarity'] . '" selected="selected">' . $clarities['Clarity']['clarity'] . '</option>';
                                        } else {
