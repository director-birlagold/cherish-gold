       ...
       <?php echo $this->Form->create('Newsletter',array('id'=>'myForm','type' => 'file','inputDefaults' => array ('fieldset' => false, 'legend' => false))); ?>        	
            <fieldset>
				...
				<?php	
                     ...
                     echo $this->Form->input('email',array('div'=>false,'error'=>false,'name'=>'data[Newsletter][email]','label' => array('text'=>'Email'.'<span class="required">*</span>'), 'before' => '<dt>', 'after' => '</dd>', 'between' => '</dt><dd>', 'class'=>"validate[required,custom[email]]",'size'=>'50'));
