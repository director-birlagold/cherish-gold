<div id="content" class="clearfix"> 
    <div class="container">
        <div class="mainheading">   
            ...
            <div class="titletag"><h1><?php echo __('Distributor-'); ?></h1></div>
        </div>
		...
		<td align="left"><?php echo $this->Html->image('icons/friend-icon.png',array('url'=>array('action'=>'referral', $customer['CustomerBGP']['customer_id']),'border'=>0,'alt'=>__('Referral')) );?></td>
		<!--  
        <td align="center">
