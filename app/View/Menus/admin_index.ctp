<div id="content" class="clearfix"> 
    <div class="container">
        ...
        <?php //echo $this->Form->create('Menu', array('action' => 'delete','id'=>'myForm','Controller'=>'orderstatuss')); ?>
                ...
                if (empty($menus))
                    ...
                    foreach ($menus as $menu):
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <?php
                                if (in_array($menu['Menu']['menu_id'], $show_submenus)) {
                                    echo $this->Html->image('icons/view.png', array('url' => array('controller' => 'submenus', 'action' => 'index', $menu['Menu']['menu_id']), 'border' => 0, 'alt' => __('Edit')));
                                }
                                ?>
                            </td>
                        </tr>
