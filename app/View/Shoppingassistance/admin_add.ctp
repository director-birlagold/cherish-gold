    ...
    <div class="container">
        ...
        <fieldset>
            ...
            <dl class="inline">
                ...
                echo $this->Form->input('description', array('div' => false, 'error' => false, 'label' => array('text' => __('Content') . '<span class="required">*</span>'), 'type' => 'textarea', 'before' => '<dt>', 'after' => '</dd>', 'between' => '</dt><dd>', 'class' => 'validate[required] text-input', 'rows' => '5', 'cols' => '50'));
                ?>
